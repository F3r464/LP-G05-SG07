...
public class PantallaNueva extends JPanel {
    ...
    private void colocarFormulario() {
        ...
        comboEscenario.addItem("1");
        comboEscenario.addItem("2");
        comboEscenario.addItem("3");
    ...
    private void crearPartida(){
        ...
        db.guardarPartida(slotLibre,nombre,"0:00",escenario,"ninguna","ninguna","ninguno");
        ventana.setContentPane(new PantallaPrincipal(ventana, slotLibre));
        ventana.revalidate();
    }
