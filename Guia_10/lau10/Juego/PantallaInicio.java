...
public class PantallaInicio extends JPanel{
    ...
    private void inicializarLogo(){
        ...
        logo.setBounds(280, 50, 400, 150);
        add(logo);
    }
    private void inicializarBotones(){
    JButton nueva = crearBotonImagen(
        "assets/boton_nueva.png",
        "assets/boton_nueva_hover.png",
        380, 250
    );

    JButton cargar = crearBotonImagen(
        "assets/boton_cargar.png",
        "assets/boton_cargar_hover.png",
        380, 320
    );
    JButton ajustes = crearBotonImagen(
        "assets/boton_ajustes.png",
        "assets/boton_ajustes_hover.png",
        380, 390
    );
    JButton salir = crearBotonImagen(
        "assets/boton_salir.png",
        "assets/boton_salir_hover.png",
        380, 460
    );
